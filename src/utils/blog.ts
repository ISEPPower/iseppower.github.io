...
export const blogText = {
  en: {
    ...
    heading: SITE_TITLE,
    description: 'Week 1: documenting the opening questions and the start of the Demand Response Advisor project.',
  ...
  pt: {
    ...
    heading: SITE_TITLE,
    description: 'Semana 1: um registo das questões iniciais e do arranque do projeto Demand Response Advisor.',
